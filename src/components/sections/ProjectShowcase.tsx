    ...
    <section id="projects" className="py-16 lg:py-24 bg-background">
      <div className="container max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-primary">Our Portfolio</h2>
          <p className="mt-4 text-lg text-foreground/80">
            Take a look at some of the innovative projects we've delivered.
          </p>
        </div>
